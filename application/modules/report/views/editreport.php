          ...
          <tr style="border:none;padding-bottom:20px;">
            ...
            <?php foreach ($dataschedule as $rows ) { ?>
              <div style="margin-bottom:10px;color:#fff;padding:10px;width:97%;height:40px;-moz-border-radius:5px 5px 5px;-webkit-border-radius:5px 5px 5px;border-radius:5px 5px 5px;background:orange;">
                ...
                <a style="float:right;padding-left:15px;padding-right:15px;" href="<?php echo base_url() ?>laporan/createxml/<?php echo $this->uri->segment(3); ?>"><img src="<?php echo base_url() ?>assets/pic/PPTs.png" width="42px" ></a>
                <a style="float:right;padding-left:15px;padding-right:15px;border-right:1px solid #ffbf4b" href="<?php echo base_url() ?>laporan/createxls/<?php echo $this->uri->segment(3); ?>"><img src="<?php echo base_url() ?>assets/pic/xls.png" width="42px" ></a>            
              </div>
            <?php } ?>  
